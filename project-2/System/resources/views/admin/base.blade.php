...
<img class="img-circle elevation-2" src="{{ url('public')}}/assets-admin/dist/img/via2.jpg" alt="User Image" style="width: 30px; height: 30px;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Toko sofa</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('public') }}/assets-admin/dist/img/herda.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Herda Monika</a>
        </div>
      </div>
