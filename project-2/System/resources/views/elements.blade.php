...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></P>
	...
	<!-- jquery plugins here-->
	<!-- jquery -->
	<script src="{{ url('pulic') }}/assets/js/jquery-1.12.1.min.js"></script>
	<!-- popper js -->
	<script src="{{ url('pulic') }}/assets/js/popper.min.js"></script>
	<!-- bootstrap js -->
	<script src="{{ url('pulic') }}/assets/js/bootstrap.min.js"></script>
	<!-- easing js -->
	<script src="{{ url('pulic') }}/assets/js/jquery.magnific-popup.js"></script>
	<!-- swiper js -->
	<script src="{{ url('pulic') }}/assets/js/swiper.min.js"></script>
	<!-- swiper js -->
	<script src="{{ url('pulic') }}/assets/js/masonry.pkgd.js"></script>
	<!-- particles js -->
	<script src="{{ url('pulic') }}/assets/js/owl.carousel.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/jquery.nice-select.min.js"></script>
	<!-- slick js -->
	<script src="{{ url('pulic') }}/assets/js/slick.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/jquery.counterup.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/waypoints.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/contact.js"></script>
	<script src="{{ url('pulic') }}/assets/js/jquery.ajaxchimp.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/jquery.form.js"></script>
	<script src="{{ url('pulic') }}/assets/js/jquery.validate.min.js"></script>
	<script src="{{ url('pulic') }}/assets/js/mail-script.js"></script>
	<!-- custom js -->
	<script src="{{ url('pulic') }}/assets/js/custom.js"></script>
</body>
